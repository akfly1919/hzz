...
class HzzApplicationTests {
	...
	public static void main(String[] args) {
		...
		BigDecimal feeB=priceB.multiply(new BigDecimal(0.0022));
		System.out.println(priceB + "---" + feeB);
		BigDecimal totalB=priceB.multiply(BigDecimal.valueOf(1)).add(feeB.multiply(BigDecimal.valueOf(1)));
